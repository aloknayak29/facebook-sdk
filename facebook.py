...
class GraphAPI(object):
    ...
    def request_url(self, url):
        """Fetches the given url in the Graph API.

        This is specially written for directly requesting
        the Paging parameters next and previous urls.
        These next and previous urls dont need additional get and post
